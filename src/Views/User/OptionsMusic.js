            ...
            if (result.isConfirmed) {
                ...
                if(!validacion.length > 0){
                    ...
                    .then(res => {
                        ...
                        window.location.replace("/Lucky-Songs/#/Playlist")
                    })
                }else{
                    Swal.fire({
                        icon : "error",
    ...
    return (
        <div>
            ...
            <div>
                {Validacion ? 
                    <div className="p-2" >
                        <h6> <strong> Add music to playlist? </strong> </h6>
                        {state.playList.map(dato => 
                            <div key={dato.id} className="bg-white p-3 w-100 my-2 pointer" onClick={ ()=>  agregarCancion(dato)} >
